def single_core_ttm(origins,destinations):
        ...
        #import sys
        #sys.argv += ["--max-memory", "32G"]
        import r5py
        
        #if pbf_path is None:
        pbf_path = r'C:\Users\routing_admin\Documents\WIMD 2025 HANDOVER\WIMD 2025 DATA\OSM PBF\wales_plus_border_10km_complete_ways.osm.pbf'
        raw_gtfs_folder = r'C:\Users\routing_admin\Documents\WIMD 2025 HANDOVER\WIMD 2025 DATA\GTFS\\'
        gtfs_paths = [
            f'{raw_gtfs_folder}NW_bus_clipped.zip',
            f'{raw_gtfs_folder}SW_bus_clipped.zip',
            f'{raw_gtfs_folder}W_bus_clipped.zip',
            f'{raw_gtfs_folder}WM_bus_clipped.zip',
            #f'{raw_gtfs_folder}train_gtfs_clipped.zip'
        ]
        print("GTFS Paths:")
        print(gtfs_paths)
